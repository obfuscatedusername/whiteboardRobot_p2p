        ...
        public void run(){
            ...
            while(running){
                ...
                try{
                    ...
                    if ("join".equals(rm.type) && !rm.id.equalsIgnoreCase(p.peerID)){
                        joinerIP = rm.ip;
                        joinReq = true;
                    ...
                    //these and add them to the whiteboard.
                            ...
                            p.theGUI.GuiControl.drawLine(np, rm.col);
            ...
            }//if we get here we have left disconected and must leave the group!
    ...
    //is.     
     ...
     public void processTCPObj(ArrayList<String> al){
         for(int i = 0 ; i < al.size(); i++){
             ...
             if(t[0].equals("draw")){
                 String[] sp = t[3].split("/");
                 Color nc = new Color(Integer.parseInt(sp[0]), Integer.parseInt(sp[1]), Integer.parseInt(sp[2]));
                 float fx = Float.parseFloat(t[1]);
                 float fy = Float.parseFloat(t[2]);
                 int x = (int)fx;
                 int y = (int)fy;
                 //System.out.println("Processed: "+t[0]+"|"+x+"|"+y+"|"+nc+"|");
                 Point np = new Point(x,y);
                 p.theGUI.GuiControl.drawLine(np, nc);
             }
             if(t[0].equals("text")){
                 String text = t[1];
                 ...
                 //System.out.println("Processed: "+t[0]+"|"+text+"|"+x+"|"+y+"|"+nc+"|"+fn+"|"+sz);
             }
            if(t[0].equals("newline")){
                System.out.println("ts[3] "+t[3]);
                String[] sp = t[3].split("/");
                Color nc = new Color(Integer.parseInt(sp[0]), 
                                     Integer.parseInt(sp[1]), 
                                     Integer.parseInt(sp[2]));
